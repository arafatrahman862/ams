                                ...
                                <div class="body">
                                    ...
                                    <form id="" method="post">
                                                <div class="form-group">
                                                    <label>Your ID</label>
                                                    <input type="text" class="form-control" id="exampleTextInput1" name="officer_id" value="<?php echo $row['officer_id']; ?>" readonly='true'>
                                                </div>
                                                <div class="form-group">
