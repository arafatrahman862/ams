                                                    ...
                                                    if (mysqli_num_rows($result) > 0) {
                                                        while ($row = mysqli_fetch_assoc($result)) {              ?>
                                                            ...
                                                            <td>
                                                                ...
                                                                { ?>
                                                                    <a href="../includes/process.php?deletewpnid=<?php echo $row["request_id"]; ?>" onclick="return confirm('Are you sure you want to remove this record?');" class="btn btn-danger">
                                                                    Remove
                                                                </a><?php
                                                                }
                                                                ?>
