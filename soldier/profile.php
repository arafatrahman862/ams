                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="body">
                                    ...
                                    $sql = "SELECT * FROM soldier WHERE soldier_id = '$id'";
                                    ...
                                    <form id="" method="post">
                                                <div class="form-group">
                                                    <label>Your ID</label>
                                                    <input type="text" class="form-control" id="exampleTextInput1" name="soldier_id" value="<?php echo $row['soldier_id']; ?>" readonly='true'>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="email2" name="name" value="<?php echo $row['name']; ?>" readonly='true'>
                                                </div>
                                                <div class="form-group">
                                                    <label>Email</label>
                                                ...
                                                <div class="form-group">
                                                    <label for="rank">Rank</label>
                                                        <select class="form-control" id="rank" name="rank" readonly='true'>
