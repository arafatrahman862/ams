                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                            ...
                                            <tbody>
                                                ...
                                                INNER JOIN officer o ON r.officer_id = o.officer_id
                                                INNER JOIN weapon w ON r.weapon_id = w.weapon_id";
                                                    ...
                                                    if (mysqli_num_rows($result) > 0) {
                                                        while ($row = mysqli_fetch_assoc($result)) {              ?>
                                                            ...
                                                            <td>
                                                                <a href="../includes/process.php?deleteid=<?php echo $row["soldier_id"]; ?>" onclick="return confirm('Are you sure you want to remove this record?');" class="btn btn-danger">
                                                                    Remove
                                                                </a>
                                                            </td>
                                                </tr>
